<footer class="mt-20 bg-white dark:bg-gray-900">
	<div class="mx-auto w-full max-w-screen-xl border-t p-4 py-6 lg:py-8">
			...
			<div class="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
				...
				<div>
					...
					<ul class="font-medium text-gray-500 dark:text-gray-400">
						<li class="mb-4">
							<a href="https://github.com/joy095" class="hover:underline">Github</a>
						</li>
					</ul>
				</div>
				<div>
		...
		<div class="sm:flex sm:items-center sm:justify-between">
			<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
				>© 2025 <a href="https://joykarmakar.vercel.app/" class="hover:underline">JoyKarmakar™</a
				>. All Rights Reserved.
			</span>
			<div class="mt-4 flex sm:mt-0 sm:justify-center">
				<a
					href="https://x.com/JoyKarmakar9871"
